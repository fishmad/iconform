        ...
        <div class="animate fadeIn">
          <div class="card">
            ...
            <div class="card-header">
              <a href="{{ route('settings.samples.index') }}" data-toggle="tooltip" title="Any changes you made will not be saved..." class="btn btn-outline-primary float-right"><i class="fa fa-step-backward fa-md"></i> Go Back</a>

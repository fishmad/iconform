        ...
        <div class="animate fadeIn">
          ...
          <div class="card">
            ...
            <div class="card-header">
              <a href="{{ route('cat.create') }}" class="btn btn-outline-primary float-right">
              Create
              </a>
              <h2><i class="fa fa-align-justify"></i> <strong>Cat</strong> Register 
                <small>
                  Create, read, update and delete cat from this screen.
                </small>
              </h2>
            </div><!-- ./card-header-->
